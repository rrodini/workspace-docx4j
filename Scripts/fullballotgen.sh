...
# STEP2  - OBSOLETE - PDF SPLIT
# STEP3  - OBSOLETE - BALLOT NAME
# STEP4  - BALLOT GENERATE  <= For Democratic Committee experts
# STEP4a - BALLOT CUSTOMIZE <= OPTIONAL and MANUAL
# STEP5  - BALLOT ZIP       <= For Democratic Committee experts
# TO activate a STEP, set STEPx value to 1
STEP1=0
#STEP2=0 - OBSOLETE by version 1.7.0
#STEP3=0 - OBSOLETE by version 1.7.0
STEP4=1
STEP5=0
...
VOTER_SERVICES_PAGES_PER_BALLOT=0
PRECINCTS_ZONES_CSV=""
...
run_populate_globals() {
    ...
    then
        ...
        COUNTY_ZONE="./chester-zone"
#        VOTER_SERVICES_SPECIMEN_PDF="General-2023.pdf"
#        VOTER_SERVICES_SPECIMEN_TXT="PRIMARY_DEM_2025_605_TREDYFFRIN_E-5.txt"
        VOTER_SERVICES_SPECIMEN_TXT="General-2023.txt"
        VOTER_SERVICES_PAGES_PER_BALLOT=0
...
then
    ...
    run_ballotzipper "${COUNTY_ZONE}/${PRECINCTS_ZONES_CSV}" "${COUNTY_OUTPUT}" "${COUNTY_ZIP}"
fi

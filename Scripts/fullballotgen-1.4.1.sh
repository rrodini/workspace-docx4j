...
#        VOTER_SERVICES_SPECIMEN="2023-Municipal-Election-Chester-County-Specimen-Ballots.pdf"
        VOTER_SERVICES_SPECIMEN="2023-Municipal-Election-Chester-ALMOST-ALMOST-GOOD.txt"
        VOTER_SERVICES_PAGES_PER_BALLOT=2
...
then
    ...
    run_contestgen "${COUNTY_INPUT}/${VOTER_SERVICES_SPECIMEN/pdf/txt}" "${COUNTY_CONTESTS}" "${COUNTY_OUTPUT}"
fi
